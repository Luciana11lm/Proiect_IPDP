...
void testRestaurantConnection() async {
  try {
    final response = await http.get(Uri.parse(API.logInRestaurant));
    if (response.statusCode == 200) {
      print(
          'Conexiunea cu restaurantul este stabilă. Răspuns: ${response.body}');
    } else {
      print(
